...
├── contentScript.js       # コンテンツスクリプト（音声再生）
├── popup.html            # ポップアップUI
├── popup.js              # ポップアップの動作制御
├── icon/                 # アイコンファイル
│   ├── youtube-live-comment-icon.png
│   ├── youtube-live-comment-icon16.png
│   ├── youtube-live-comment-icon48.png
│   └── youtube-live-comment-icon128.png
└── style/                # スタイルシート
    ├── styles.scss       # SCSSソースファイル
    ├── styles.css        # コンパイル済みCSS
    └── styles.min.css    # 圧縮済みCSS
```
